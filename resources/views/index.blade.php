...
<head>
    ...
    <title>MyBindle - Home</title>

    <!-- Fonts -->
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600" rel="stylesheet" />
    <link rel="stylesheet" href="./MyBindle/assets/css/style.css">
    <link rel="stylesheet" href="../MyBindle/assets/css/resp.css">
    <link rel="icon" href="../MyBindle/assets/images/fav.png" type="image/x-icon">
...
<header class="custom-header">
    <!-- Centered Logo -->
    <div class="logo">
        <img src="./MyBindle/assets/images/logo.png" alt="logo" class="logo-img">
    </div>
    ...
    @if (Route::has('login'))
        <nav class="auth-nav">
            ...
            @else
                <a href="{{ route('login') }}" class="auth-btn">Admin</a>
...
<section class="hero">
    <div class="text">
        ...
        <a href="{{ $sections['hero']['button_url'] ?? '#' }}">
            <button id="get">{{ $sections['hero']['button_text'] ?? '' }}</button>
        </a>
    </div>
    <div class="banner">
        <img src="{{ asset('storage/' . ($sections['hero']['image_path'] ?? 'uploads/hero.png')) }}" alt="Hero Image">
    </div>
</section>
...
<section class="features">
    <div class="heading">
        <h1>{!! $sections['features']['heading'] ?? '' !!}</h1>
        <p>{!! $sections['features']['subheading'] ?? '' !!}</p>
    </div>
    <div class="card-box">
        <div class="inner-box">
            @for ($i = 1; $i <= 3; $i++)
                <div class="card">
                    <h3>{{ $sections['features']['card_'.$i.'_title'] ?? '' }}</h3>
                    <p>{!! $sections['features']['card_'.$i.'_desc'] ?? '' !!}</p>
                </div>
            @endfor
        </div>
    </div>
...
<section class="about">
    <div class="image">
             <img src="{{ asset('storage/' . ($sections['about']['image_path'] ?? 'uploads/about.png')) }}" alt="about">
    </div>
    <div class="addtional-text">
        <div>
            <h3>{!! $sections['about']['heading'] ?? '' !!}</h3>
            <p>{!! $sections['about']['desc'] ?? '' !!}</p>
        </div>
        <div>
            @for ($i = 1; $i <= 3; $i++)
                <div class="about-card">
                    <h3>{{ $sections['about']['card_'.$i.'_title'] ?? '' }}</h3>
                    <p>{!! $sections['about']['card_'.$i.'_desc'] ?? '' !!}</p>
                </div>
            @endfor
        </div>
    </div>
...
<section class="cta">
    <div class="cta-box">
        <div class="cta-text">
            <h1>{!! $sections['cta']['heading'] ?? '' !!}</h1>
            <p>{!! $sections['cta']['desc'] ?? '' !!}</p>
            <a href="{{ $sections['cta']['button_url'] ?? '#' }}">
                <button id="get">{{ $sections['cta']['button_text'] ?? '' }}</button>
            </a>
        </div>
        <div class="cta-image">
             <img src="{{ asset('storage/' . ($sections['cta']['image_path'] ?? 'uploads/cta.png')) }}" alt="CTA Image">
        </div>
    </div>
</section>
        ...
        <div>
            ...
            <div class="testimonial-container">
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <div class="text">
                        This platform changed the way I stay in touch with my friends and family. The interface is
                        smooth,
                        and I love how easy it is to share my moments!
                    </div>
                    <div class="user">
                        <img src="https://i.pravatar.cc/40?img=1" alt="Emily R" />
                        <div class="user-info">
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <div class="text">
                        Finally, a social network that understands what I need! The privacy features are a game-changer,
                        and
                        I feel safer sharing my life online
                    </div>
                    <div class="user">
                        <img src="https://i.pravatar.cc/40?img=2" alt="Amit K" />
                        <div class="user-info">
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <div class="text">
                        I joined just to explore, but now I can't imagine my day without it. The real-time chat and
                        engaging
                        communities make every interaction special!
                    </div>
                    <div class="user">
                        <img src="https://i.pravatar.cc/40?img=3" alt="Sophie M" />
                        <div class="user-info">
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <div class="text">
                        Running my small business has never been easier! This platform helped me connect with customers,
                        promote my products, and grow my brand
                    </div>
                    <div class="user">
                        <img src="https://i.pravatar.cc/40?img=4" alt="Javier L" />
                        <div class="user-info">
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <div class="text">
                        The perfect blend of fun and functionality! Whether I want to go live, discover trending
                        content, or
                        just catch up with friends, everything is right here!
                    </div>
                    <div class="user">
                        <img src="https://i.pravatar.cc/40?img=5" alt="Lucas T" />
                        <div class="user-info">
                            <strong>Lucas T</strong>
                            Brazil
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <div class="text">
                        I've tried many social platforms, but this one truly stands out! The experience feels personal,
                        the
                        connections feel real, and every feature just makes sense
                    </div>
                    <div class="user">
                        <img src="https://i.pravatar.cc/40?img=6" alt="Nora S" />
                        <div class="user-info">
                            <strong>Nora S</strong>
                            Canada
                        </div>
                    </div>
                </div>
...
<section class="footer">
    <div class="footer-box">
        <div class="footer-text">
            <h1>{!! $sections['footer']['heading'] ?? '' !!}</h1>
            <p>{!! $sections['footer']['desc'] ?? '' !!}</p>
            <div class="download-buttons">
                <img src="./MyBindle/assets/images/download.png" alt="download">
            </div>
        </div>
        <div class="footer-image">
             <img src="{{ asset('storage/' . ($sections['footer']['image_path'] ?? 'uploads/cta.png')) }}" alt="footer">
        </div>
    </div>
</section>
